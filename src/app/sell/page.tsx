...
const formSchema = z.object({
  name: z.string({
    required_error: "Por favor, ingresa el nombre del vehículo",
  }),
  year: z
    .string({ required_error: "El año solo puede tener 4 dígitos" })
    .max(4),
  make: z.enum(popularMakes as [string, ...string[]], {
    required_error: "Por favor, selecciona una marca",
  }),
  mileage: z
    .string({ required_error: "Por favor, coloca el kilometraje" })
    .max(6),
  contactnum: z
    .string({ required_error: "Por favor, coloca un número de contacto" })
    .max(10),
